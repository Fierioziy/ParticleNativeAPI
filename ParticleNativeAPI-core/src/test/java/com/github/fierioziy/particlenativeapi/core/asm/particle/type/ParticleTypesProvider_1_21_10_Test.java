...
import com.github.fierioziy.particlenativeapi.core.mocks.nms.v1_21_10.PowerParticleOption;
import com.github.fierioziy.particlenativeapi.core.mocks.nms.v1_21_10.SpellParticleOption;
import com.github.fierioziy.particlenativeapi.core.mocks.nms.v1_21_3.DustColorTransitionOptions_1_21_3;
import com.github.fierioziy.particlenativeapi.core.mocks.nms.v1_21_3.ParticleParamRedstone_1_21_3;
import com.github.fierioziy.particlenativeapi.core.mocks.nms.v1_21_4.PacketPlayOutWorldParticles_1_21_4;
...
public class ParticleTypesProvider_1_21_10_Test {
    ...
    public static void prepareAPI() {
        api = ParticleNativeCoreTest.getAPI_1_21_10();
    }
    ...
    public void test_ParticleTypeDust() {
        ...
        verifyPacket(objPacket,
                new ParticleParamRedstone_1_21_3(
                        0xFF000000 | (255 << 16) | (125 << 8) | 50,
                        2F
                ), true,
                1D, 2D, 3D,
                4F, 5F, 6F,
    ...
    public void test_ParticleTypeDustColorTransition() {
        ...
        verifyPacket(objPacket,
                new DustColorTransitionOptions_1_21_3(
                        0xFF000000 | (255 << 16) | (125 << 8) | 50,
                        0xFF000000 | (200 << 16) | (100 << 8) | 20,
                        2F
                ), true,
                1D, 2D, 3D,
                4F, 5F, 6F,
    ...
    @Test
    public void test_ParticleTypePowerMotion() {
        ParticleTypePowerMotion type = api.LIST_1_19_PART.DRAGON_BREATH;

        assertTrue(type.isPresent(), "Particle type is invalid for some reason");

        Object objPacket = unwrapPacket(type.power(2).packet(true,
                1D, 2D, 3D,
                4D, 5D, 6D,
                7F, 8
        ));
        ...
        verifyPacket(objPacket,
                PowerParticleOption.newPowerInstance_obf(Particles_1_21_10.DRAGON_BREATH, 2F), true,
                1D, 2D, 3D,
                4F, 5F, 6F,
                7F, 8);

        ParticleType selectedType1 = type.power(2F);
        ParticleType selectedType2 = type.power(2F);

        assertSame(selectedType1, selectedType2, "ParticleTypePower returns different wrapper particle type instance");
    }

    @Test
    public void test_ParticleTypeSpell() {
        ParticleTypeSpell type = api.LIST_1_19_PART.EFFECT;
        ...
        Object objPacket = unwrapPacket(type.spell(red, green, blue, alpha, power).packet(true,
                1D, 2D, 3D,
                4D, 5D, 6D,
                7D, 8
        ));
        ...
        verifyPacket(objPacket,
                SpellParticleOption.newSpellInstance_obf(
                        Particles_1_21_10.EFFECT,
                        expectedColor,
                        (float) power
                ), true,
                1D, 2D, 3D,
        ...
        ParticleType selectedType1 = type.spell(255, 255, 255, 255, 2D);
        ParticleType selectedType2 = type.spell(255, 255, 255, 255, 2D);
    ...
    private void verifyPacket(Object objPacket,
        ...
        assertTrue(objPacket instanceof PacketPlayOutWorldParticles_1_21_4,
        ...
        PacketPlayOutWorldParticles_1_21_4 packet = (PacketPlayOutWorldParticles_1_21_4) objPacket;
        assertEquals(particle, packet.particle);
        assertEquals(far, packet.far);
        assertEquals(far, packet.alwaysShow);
