...
public class SpigotClassRegistryProvider_1_18 implements SpigotClassRegistryProvider {
    ...
    public SpigotClassRegistry provideRegistry() {
        ...
        post 1.17
         */
        classRegistry.entityPlayer_1_17 =                           classRegistry.of(EntityPlayer_1_18.class);
        classRegistry.packet_1_17 =                                 classRegistry.of(Packet.class);
        classRegistry.playerConnection_1_17 =                       classRegistry.of(PlayerConnection_1_18.class);
        ...
        classRegistry.particles_1_17 =                              classRegistry.of(Particles_1_18.class);
