package com.github.fierioziy.particlenativeapi.core.asm.particle.type.v1_17.skeleton;
...
public abstract class ParticleTypeSkeletonASM_1_17 extends ParticleTypeSkeletonASM {

    public ParticleTypeSkeletonASM_1_17(ContextASM context, ClassSkeleton superType) {
        super(context, superType);
    }

    @Override
    protected void writeFields(ClassWriter cw) {
        cw.visitField(ACC_PRIVATE, PARTICLE_FIELD_NAME, refs.particleParam_1_17.desc(), null, null).visitEnd();
    ...
    private void writeConstructor_ParticleParam(ClassWriter cw) {
        MethodVisitor mv = cw.visitMethod(ACC_PUBLIC,
                "<init>", "(" + refs.particleParam_1_17.desc() + ")V",
                null, null);
        mv.visitCode();
        ...
        mv.visitFieldInsn(PUTFIELD, implType.internalName(),
                          PARTICLE_FIELD_NAME, refs.particleParam_1_17.desc());
    ...
    private void writeMethod_setParticle(ClassWriter cw) {
        MethodVisitor mv = cw.visitMethod(ACC_PUBLIC,
                SET_PARTICLE_METHOD_NAME, "(" + refs.particleParam_1_17.desc() + ")V",
                null, null);
        mv.visitCode();
