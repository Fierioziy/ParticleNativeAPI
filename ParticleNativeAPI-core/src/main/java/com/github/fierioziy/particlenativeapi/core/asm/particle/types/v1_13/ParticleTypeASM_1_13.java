...
public class ParticleTypeASM_1_13 extends ClassSkeletonASM {

    public ParticleTypeASM_1_13(InternalResolver resolver, String suffix, ClassMapping superType) {
        super(resolver, suffix, superType);
    }

    @Override
    protected void writeFields(ClassWriter cw) {
        writeFields(cw, refs.particleParam_1_7);
    }

    @Override
    protected void writeConstructor(ClassWriter cw) {
        writeConstructor(cw, refs.particleParam_1_7);
    }
