...
public class ParticleTypesProvider_1_19_3 extends ParticleTypesProvider_1_18 {
    ...
    public ParticleTypesProvider_1_19_3(InternalResolver resolver,
        ...
        super(resolver, "_1_19_3", particlePacketProvider, resolver.getParticles_1_19_3());
    }
    ...
    public void registerClasses() {
        ...
        new ParticleTypeDustASM_1_19_3(
                internal, suffix,
                ClassSkeleton.PARTICLE_TYPE_DUST,
                ClassSkeleton.PARTICLE_TYPE)
                .registerClass();
        new ParticleTypeDustTransitionASM_1_19_3(
                internal, suffix,
        ...
        new ParticleTypeRedstoneASM_1_19_3(
                internal, suffix,
                particlePacketImpl_X)
                .registerClass();
