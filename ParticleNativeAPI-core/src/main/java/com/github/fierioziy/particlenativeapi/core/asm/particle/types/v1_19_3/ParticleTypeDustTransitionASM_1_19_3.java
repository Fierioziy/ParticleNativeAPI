...
public class ParticleTypeDustTransitionASM_1_19_3 extends ParticleTypeASM_1_17 {

    private final ClassMapping implReturnType;
    private final ClassMapping returnType;

    public ParticleTypeDustTransitionASM_1_19_3(InternalResolver resolver, String suffix, ClassMapping superType, ClassMapping returnType) {
    ...
    private void writeMethod_color(ClassWriter cw) {
        ...
        // new DustColorTransitionOptions(new Vector3f(r, g, b), new Vector3f(tr, tg, tb), size);
        ...
        mv.visitMethodInsn(INVOKESPECIAL,
                ...
                "<init>",
                "(" + refs.vector3f.desc() + refs.vector3f.desc() + "F)V", false);
