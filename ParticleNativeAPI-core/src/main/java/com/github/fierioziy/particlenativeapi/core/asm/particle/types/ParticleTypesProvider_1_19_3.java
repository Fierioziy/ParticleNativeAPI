...
public class ParticleTypesProvider_1_19_3 extends ParticleTypesProvider_1_18 {
    ...
    public ParticleTypesProvider_1_19_3(InternalResolver resolver) {
        super(resolver, "_1_19_3", resolver.getParticles_1_19_3());
    }
    ...
    public void defineClasses() {
        ...
        new ParticleTypeDustASM_1_19_3(internal, suffix, refs.particleTypeDust, refs.particleType).defineClass();
        new ParticleTypeDustTransitionASM_1_19_3(internal, suffix, refs.particleTypeDustTransition, refs.particleType).defineClass();
        ...
        new ParticleTypeRedstoneASM_1_19_3(internal, suffix, refs.particleTypeRedstone).defineClass();
