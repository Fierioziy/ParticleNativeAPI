...
/**
 * <p>Class used to represent particle type that needs a color, transparency settings and power.</p>
 *
 ...
 * @see ParticleType
 */
public interface ParticleTypeSpell {

    /**
     * <p>Selects a color, transparency and power this particle should get.</p>
     *
     ...
     * color.
     */
    @Shared ParticleType spell(Color color, int alpha, double power);
     ...
     * color.
     */
    @Shared ParticleType spell(int r, int g, int b, int alpha, double power);
